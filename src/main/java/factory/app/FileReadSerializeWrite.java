...
public class FileReadSerializeWrite {
    ...
    public static void main(String... args) throws Exception {
		...
		Fallback business = null;
		FileReaderFactory fileReaderFactory=FileReaderFactory.newFileReaderFactory(fileName, business);
		AbstractFileReader reader=fileReaderFactory.fileReader(fileName);
		reader.readFile();
